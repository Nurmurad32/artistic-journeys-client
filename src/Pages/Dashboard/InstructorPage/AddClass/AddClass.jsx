        ...
        <div className="w-full px-10">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="form-control w-full ">
                    ...
                    <input type="text" placeholder="Type here" {...register("title", { required: true })} className="input input-bordered w-full " />
                ...
                <div className='flex'>
                    <div className="form-control w-full ml-4">
                        ...
                        <input type="text" defaultValue={user && user.displayName} placeholder="Type here" className="input input-bordered w-full " disabled />
                    </div>
                    <div className="form-control w-full ml-4">
                        <label className="label">
                            <span className="label-text font-semibold">Instructor Email</span>
                        </label>
                        <input type="email" defaultValue={user && user.email}  placeholder="Type here" className="input input-bordered w-full " disabled />
                    </div>
                </div>
                <div className='flex'>
                    <div className="form-control w-full ml-4">
                ...
                <div className="form-control">
                    <label className="label">
                        <span className="label-text font-semibold">Class Details</span>
                    </label>
                    <textarea {...register("classdes", { required: true })} className="textarea textarea-bordered h-24" placeholder="Class Details"></textarea>
